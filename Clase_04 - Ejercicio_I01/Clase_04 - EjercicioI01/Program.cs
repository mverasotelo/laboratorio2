...
namespace Clase_04___EjercicioI01
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            Console.WriteLine($"Cantidad de sumas sumador (constructor inicializado en 0): {(int)sumador}\n");
            Console.WriteLine($"Cantidad de sumas sumador2 (constructor inicializado segun valor recibido por parametro): {(int)sumador2}\n");
            ...
            Console.WriteLine($"Nueva cantidad de sumas sumador: {(int) sumador}\n");
            Console.WriteLine($"Nueva cantidad de sumas sumador2: {(int) sumador2}\n");
